	...
	public void Cupon_Valido_Contiua_Comprando() throws InterruptedException
	{
		...
		//Validar si existe AccountName Nombre de usuario Registrado
		  ...
		  if (val1) {
			  ...
			  System.out.println("CPA_16: Usuario logeado en Sistema para Ejecucion: " +username);		 
			  TakeScreenShot.takeScreenShot(driver, "CPA_16_val1_evidencia_OK_");
		  }	 
		  else {
			  TakeScreenShot.takeScreenShot(driver, "CPA_16_val1_evidencia_NOK_");
			  System.out.println("CPA_16: Problema de login con los siguientes datos: " +user+".");
			  login_page.close();
			  Assert.assertTrue(val1, "CPA_16: Problema de login con los siguientes datos: " +user+".");
	  	  }
	   ...
	   ////************** VALIDACION 3 :  Verificar texto descriptivo del cupón*****************
		Thread.sleep(2000);
		System.out.println("CPA_16: Se valida texto descriptivo del cupón: " + cupon);
