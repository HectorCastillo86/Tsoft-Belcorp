...
public class CPA_17_Eliminar_Prod_A_Cupon_Valido_C_Comprando {
	...
	@Test
	public void Eliminar_Prod_A_Cupon_Valido_C_Comprando() throws InterruptedException
	{
		...
		// Login Belcorp
				...
				//Validar si existe AccountName Nombre de usuario Registrado
				  ...
				  if (val1) {
					  ...
					  System.out.println("CPA_17: Usuario logeado en Sistema para Ejecucion: " +username);		 
					  TakeScreenShot.takeScreenShot(driver, "CPA_17_val1_evidencia_OK_");
				  }	 
				  else {
					  TakeScreenShot.takeScreenShot(driver, "CPA_17_val1_evidencia_NOK_");
					  System.out.println("CPA_17: Problema de login con los siguientes datos: " +user+".");
					  login_page.close();
					  Assert.assertTrue(val1, "CPA_17: Problema de login con los siguientes datos: " +user+".");
			  	  }
				...
				System.out.println("CPA_17: Se valida Url de Bolsa de Compra URL: "+val2);
			    //Esperar 2 Seg
				Thread.sleep(2000);
				// Validacion Visual
				TakeScreenShot.takeScreenShot(driver, "CPA_17_val2_evidencia_OK_");
