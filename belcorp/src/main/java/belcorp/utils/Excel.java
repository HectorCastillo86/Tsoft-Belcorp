...
public class Excel {
	...
	private static List<List<String>> getDatosHojaExcel2(String nombreDatapool, int nrohoja, ExcelType tipo) throws IOException {
		...
		try {
			// Crea un FileInputStream para leer el archivo excel
			 FileInputStream archivo = new FileInputStream("C:\\Jenkins\\Data\\" + nombreDatapool);
			//InputStream archivo = Excel.class.getResourceAsStream(nombreDatapool);
			// Create un libro excel desde el archivo.
			Workbook libro = createWorkBook(archivo, tipo);
	...
	public static List<List<String>> leerArchivoXLSX2(String nomArchivo, int hoja) throws IOException {

		List<List<String>> datosExcel = new ArrayList<List<String>>();
		datosExcel = getDatosHojaExcel2(nomArchivo, hoja, ExcelType.XLSX);
